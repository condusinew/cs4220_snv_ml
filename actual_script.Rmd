...
syn2.2_features <- df3[13:19] #make sure u dont train on other data for mice
...
real2.2preds_unweight <- predict(best_model_unweight, mice1two)
real2.2preds_weight <- predict(best_model_weight, mice1two)
```
