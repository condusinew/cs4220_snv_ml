...
#install.packages("randomForest")
  ...
  df3_narm$correct <- as.factor(df3_narm$TRUTH)
  ...
  rf_model <- randomForest(TRUTH ~ ., data = training_set, ntree = 100, importance = TRUE)
 
 
  test_predictions <- predict(rf_model, newdata = test_set)
 
  confusion_matrix <- table(test_set$TRUTH, test_predictions)
