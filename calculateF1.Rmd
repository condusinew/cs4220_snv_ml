...
```{r}
truth = read.table('meantest_TRUTH.bed', header = F)
mypred = read.table("meantest_predictions.bed", header = FALSE) #changed to header = false
f1statsmean = calc.F1(mypred, truth)
print(f1statsmean)
```
